...
import type { PhotoEntry } from '../App';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            <Button variant="ghost" onClick={() => setShowSketchEditor(false)} className="p-2">
                      ...
                      {colors.map((color) => (
                        <button
                          ...
                          className={`w-6 h-6 rounded-full border-2 ${
                            currentColor === color && !isEraser ? 'border-primary' : 'border-border'
                          }`}
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button onClick={handleReplaceImage} disabled={!newImageUrl.trim()}>
                Replace Image
              </Button>
            </div>
          </div>
